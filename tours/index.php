<?php
  ...
  $db->connect($config);
  $no=1;
  $query=$db->query("SELECT * FROM tour INNER JOIN ciudad ON tour.id_tour=ciudad.id_tour ");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table class="table">
          <thead>
            <tr>
              ...
              <th scope="col">Costo grupal</th>
              <th scope="col">min_ptour</th>
          ...
          <tbody>
            ...
            while($array = pg_fetch_array($query)) {
              ...
              <tr>
                <th scope='row'>{$no}</th>
                <td>{$array['id_tour']}</td>
                <td>{$array['nom_tour']}</td>
                <td>{$array['cost_tourind']}</td>
                <td>{$array['cost_tourg']}</td>
                <td>{$array['min_ptour']}</td>
                <td>{$array['nom_ciudad']}</td>
